...
# while True:
#     sorted_cnt_class = bfs()
#     if sorted_cnt_class:
#         print(cnt_remove)
#         print(*sorted_cnt_class)
#         break
...
#     remove_idx = remove_bf_list[cnt_remove]
#     f1, f2 = bf_list[remove_idx]
#     adj_list[f1] = list(filter(lambda x: x != f2, adj_list[f1]))
#     adj_list[f2] = list(filter(lambda x: x != f1, adj_list[f2]))
#     cnt_remove += 1